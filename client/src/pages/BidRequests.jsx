...
const BidRequests = () => {
  ...
  const { mutateAsync } = useMutation({
    ...
    onSuccess: () => {
      ...
      // refresh UI for the latest data
      // refetch();
      
      // kothin vabe refetch kara
  ...
  const handleStatus = async (id, preStatus, status) => {
    if (preStatus === status) return console.log("Already done it!")
    await mutateAsync({ id, status })
  }

  if (isLoading) return <p className="text-center">Data is still Loading.....</p>
